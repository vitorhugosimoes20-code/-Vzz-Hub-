...
local Window = Fluent:CreateWindow({Title = "👑 Vzz Hub 👑",SubTitle = "| By: Vzz_onT0ppp ",TabWidth = 180,Size = UDim2.fromOffset(660, 440),Acrylic = false,Theme = "Rose",MinimizeKey = Enum.KeyCode.End})
